import sqlite3
from flask import Flask, render_template, g, request, url_for, flash, session, redirect, abort
...
def delete():
	...
	print(request.form['category'], request.form['priority'], request.form['description'])
